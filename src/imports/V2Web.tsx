import svgPaths from "./svg-2etod346or";
...
function Frame1() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[32px] px-[40px] py-[24px] rounded-bl-[16px] rounded-br-[16px] shadow-[0px_16px_32px_-12px_rgba(14,18,27,0.1)] top-0 w-[1448px]">
      <Frame8 />
      <Frame7 />
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute h-[844px] left-[32px] overflow-clip rounded-[24px] shadow-[0px_16px_32px_-12px_rgba(14,18,27,0.1)] top-[151px] w-[1448px]">
...
function HeaderFooterDocumentation() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[32px] items-start left-[32px] overflow-clip px-[100px] py-[32px] rounded-tl-[24px] rounded-tr-[24px] w-[1448px]" data-name="Header & Footer [Documentation]">
      <Frame16 />
      <Frame17 />
    </div>
  );
